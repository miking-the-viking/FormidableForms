import { INumberRange } from '@/models/Formidable/Field/FormidableNumberRange';
...
export class NumberRange implements INumberRange {
    ...
    @IsGreaterThanOrEqualTo('from', {
        message: (v) => 'to property must be greater than or equal to the from property: ' + v.object.from
    })
    @IsOptional()
