                    ...
                    if (args.object) {
                        if (
                            ((args.object as FormidableLink).minLinkHrefLength
                                ? value.href.length < ((args.object as FormidableLink).minLinkHrefLength as number)
                                : false) ||
                        ...
                        if (
                            ((args.object as FormidableLink).minLinkTextLength
                                ? value.text.length < ((args.object as FormidableLink).minLinkTextLength as number)
                                : false) ||
