...
.home.container-fluid
    ...
    md-list
        md-list-item
            ...
            div.md-list-item-text
                span Basic Form
                span Basic Forms are as simple as they come: a single form with 1...N Fields 
                span
        ...
        md-list-item 
            ...
            div.md-list-item-text
                span Wizard Form
                span Wizard Forms are a little more advanced as they are designed to have 1...N Steps each containing 1...N Fields.
                span
    ...
    md-list
        md-list-item(v-for="fieldType in fieldTypeDescriptions" :key="fieldType.key")
            md-icon info
            .md-list-item-text
                span 
                    code {{fieldType.key}}
